...
def build_vision_engine(model_path, output_dir, max_batch_size=8):
    cmd = (
...
def build_decoder_engine(model_path, output_dir, max_batch_size=8):
    ...
    cmd2 = (
        ...
        f"--max_encoder_input_len 8200"  # Matches docs for MLLaMA
    )
...
def main():
    ...
    build_vision_engine(args.model_path, args.output_dir, args.max_batch_size)
    print("Building decoder...")
    build_decoder_engine(args.model_path, args.output_dir, args.max_batch_size)
